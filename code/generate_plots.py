...
"""
Script to generate traces for QRTD and SQD plots.
Generates 50 traces for 50 different seeds at 100 seconds each for both large_1 and large_3 instances.

Parameters:
    method (String): local search method
    directory (String): Directory to place the generated traces

Outputs:
    Trace files in input directory
"""
...
"""
Script to generate QRTD and SQD plots.
Uses traces generated by above method.

Parameters:
    method (String): local search method
    regen (boolean): whether to generate new traces

Outputs:
    png of QRTD and SQD plots
"""
